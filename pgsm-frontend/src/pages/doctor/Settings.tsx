...
export default function DoctorSettings() {
  ...
  const [accountSettings, setAccountSettings] = useState({
    ...
    email: "h.alami@hopital-enfants.ma",
                ...
                <div className="space-y-3 pt-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => setNotificationSettings({ ...notificationSettings, studentUpdates: checked })}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <Switch
                      checked={notificationSettings.logbookAlerts}
                      onCheckedChange={(checked) => setNotificationSettings({ ...notificationSettings, logbookAlerts: checked })}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => setNotificationSettings({ ...notificationSettings, evaluationReminders: checked })}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Safari sur Mac • 10.0.0.50</p>
                      </div>
                      <Button variant="outline" size="sm" disabled>{t("settings.current")}</Button>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                      <div>
                        <p className="font-medium">{t("settings.tablet")}</p>
                        <p className="text-xs text-muted-foreground">iPad • {t("settings.lastActive")} 1h</p>
                      </div>
