...
const activeInternships: ActiveInternship[] = [
  {
    id: "1",
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-muted-foreground">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate">{internship.hospital}</span>
                        </div>
                        <div className="flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        <Progress value={internship.progress} className="flex-1" />
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-success">{internship.attendanceRate}%</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-medium text-success text-lg">{internship.finalGrade}</p>
                    </div>
                  </div>
