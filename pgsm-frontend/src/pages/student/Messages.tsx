...
import { Send, Search, Paperclip, Check, CheckCheck, Clock, Loader2 } from "lucide-react";
...
export default function Messages() {
  ...
  if (loading) return <AppLayout role="student" userName={user?.first_name || 'Student'}><LoadingState message="Loading messages..." /></AppLayout>;
  if (error) return <AppLayout role="student" userName={user?.first_name || 'Student'}><ErrorState message={error} onRetry={fetchConversations} /></AppLayout>;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-250px)]">
          ...
          <Card className="p-4 flex flex-col">
            ...
            {filteredConversations.length === 0 ? (
              <EmptyState title="No conversations" description="Start a conversation with your tutor" />
            ) : (
