...
export default function HospitalDashboard() {
  ...
  const notificationActivities = notifications.slice(0, 5).map((n) => {
    let type: "application" | "evaluation" | "message" | "internship" | "document" = "application";
    if (n.type === "application" || n.type === "evaluation" || n.type === "message" || n.type === "internship" || n.type === "document") {
      type = n.type;
    }

    const status: "info" | "warning" | "success" | "default" =
      n.priority === "high" ? "warning" : n.is_read ? "default" : "info";
          ...
          <div className="space-y-6">
            ...
            <div className="stat-card">
              ...
              {notificationActivities.length > 0 ? (
                <ActivityFeed activities={notificationActivities} />
              ) : (
