        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/hospital/messages" element={<ProtectedRoute allowedRoles={['hospital']}><HospitalMessages /></ProtectedRoute>} />
              <Route path="/hospital/notifications" element={<ProtectedRoute allowedRoles={['hospital']}><HospitalNotifications /></ProtectedRoute>} />
